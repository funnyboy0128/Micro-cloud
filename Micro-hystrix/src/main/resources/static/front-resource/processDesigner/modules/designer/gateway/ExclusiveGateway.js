draw2d.ExclusiveGateway = function() {
	var _url = "designer/icons/gateway.exclusive.png";
...
draw2d.ExclusiveGateway.prototype.figureDoubleClick = function() {
	...
	openProperties(event.getId(), 'gatewayProperties');
};
...
draw2d.ExclusiveGateway.prototype.toXML = function() {
	...
	if (newName != null && newName != "")
		name = newName;
	var xml = '<exclusiveGateway id="' + this.gatewayId + '" name="' + name
			+ '"></exclusiveGateway>\n';
	return xml;
};
draw2d.ExclusiveGateway.prototype.toBpmnDI = function() {
	...
	var xml = '<bpmndi:BPMNShape bpmnElement="' + this.gatewayId
			+ '" id="BPMNShape_' + this.gatewayId + '">\n';
