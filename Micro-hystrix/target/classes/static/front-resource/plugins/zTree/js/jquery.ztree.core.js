    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            expandCollapseNode: function (setting, node, expandFlag, animateFlag, callback) {
                ...
                if (isParent) {
                    ...
                    if (node.open) {
                        ...
                        view.replaceIcoClass(node, icoObj, consts.diyIcon.OPEN);
                        ...
                        view.replaceIcoClass(node, icoObj, consts.diyIcon.CLOSE);
            ...
            makeNodeIcoClass: function (setting, node) {
                ...
                if (!node.isAjaxing) {
                    ...
                    if(!node.iconSkin){
                        ...
                        // }
                        // icoCss = consts.className.BUTTON + " " + icoCss.join('_');

                        // icoCss = consts.className.BUTTON + " " + icoCss.join('_');
                        if (isParent) {
                            icoCss = node.open ? consts.diyIcon.OPEN : consts.diyIcon.CLOSE;
                        } else {
                            icoCss= consts.diyIcon.DOCU;
                        }

                    }else {
                        icoCss = "layui-icon " + node.iconSkin;
                    }
                }
                return icoCss;
            },
            ...
            replaceIcoClass: function (node, obj, newName) {
                ...
                if (tmpList[tmpList.length - 1] == newName) {
                    switch (newName) {
                        case consts.folder.OPEN:
                        case consts.folder.CLOSE:
                        case consts.folder.DOCU:
                        case consts.diyIcon.OPEN:
                        case consts.diyIcon.CLOSE:
                        case consts.diyIcon.DOCU:
            ...
            replaceSwitchClass: function (node, obj, newName) {
                ...
                if (newName !== consts.folder.DOCU||newName !== consts.diyIcon.DOCU) {
