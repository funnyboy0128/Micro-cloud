draw2d.Start = function() {
	var _url = "designer/icons/startevent.png";
...
draw2d.Start.prototype.setWorkflow = function(_4fe5) {
	...
	if (_4fe5 !== null && this.rightOutputPort === null) {
		...
		this.rightOutputPort
				.setBackgroundColor(new draw2d.Color(245, 115, 115));// 定义连接点的颜色
...
draw2d.Start.prototype.figureDoubleClick = function() {
	...
	openProperties(event.getId(), 'eventProperties');
};
...
draw2d.Start.prototype.toXML = function() {
	var xml = '<startEvent id="' + this.eventId + '" name="' + this.eventName
...
draw2d.Start.prototype.toBpmnDI = function() {
	...
	var xml = '<bpmndi:BPMNShape bpmnElement="' + this.eventId
