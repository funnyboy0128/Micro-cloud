draw2d.TimerBoundary = function(_url) {
	_url = "designer/icons/timerevent.png";
...
draw2d.TimerBoundary.prototype.generateId = function() {
	this.id = "escalationTimer" + Sequence.create();
...
draw2d.TimerBoundary.prototype.toXML = function() {
	...
	if (attached != null && attached != "")
		attached = attached;
	var xml = '<boundaryEvent id="' + this.boundaryId
			+ '" cancelActivity="true" attachedToRef="' + attached + '">\n';
...
draw2d.TimerBoundary.prototype.toBpmnDI = function() {
	...
	var xml = '<bpmndi:BPMNShape bpmnElement="' + this.boundaryId
			+ '" id="BPMNShape_' + this.boundaryId + '">\n';
