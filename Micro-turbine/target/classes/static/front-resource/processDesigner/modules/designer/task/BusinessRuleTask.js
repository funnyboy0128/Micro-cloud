...
draw2d.BusinessRuleTask.prototype.getStartElementXML = function() {
	...
	var xml = '<businessRuleTask id="' + this.taskId
			+ '" activiti:ruleVariablesInput="' + this.rulesInput
			+ '" activiti:resultVariables="' + this.rulesOutputs + '"';
...
draw2d.BusinessRuleTask.prototype.toBpmnDI = function() {
	...
	var xml = '<bpmndi:BPMNShape bpmnElement="' + this.taskId
