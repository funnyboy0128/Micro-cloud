draw2d.CallActivity = function(_url) {
	_url = "designer/icons/callactivity.png";
...
draw2d.CallActivity.prototype.generateId = function() {
	this.id = "callSubProcess" + Sequence.create();
...
draw2d.CallActivity.prototype.setWorkflow = function(_4fe5) {
	...
	if (_4fe5 !== null && this.rightOutputPort === null) {
		...
		// this.rightOutputPort.setBackgroundColor(new
		// draw2d.Color(245,115,115));
	...
	if (_4fe5 !== null && this.leftOutputPort === null) {
		...
		// this.leftOutputPort.setBackgroundColor(new
		// draw2d.Color(245,115,115));
	...
	if (_4fe5 !== null && this.bottomOutputPort === null) {
		...
		// this.bottomOutputPort.setBackgroundColor(new
		// draw2d.Color(245,115,115));
...
draw2d.CallActivity.prototype.figureDoubleClick = function() {
	...
	openProperties(event.getId(), 'subProcessProperties');
};
draw2d.CallActivity.prototype.getContextMenu = function() {
	...
	menu.appendMenuItem(new draw2d.ContextMenuItem("属性",
			"properties-icon", data, function(x, y) {
...
draw2d.CallActivity.prototype.toXML = function() {
	...
	var xml = '<callActivity id="' + this.subProcessId + '" name="' + this.name
			+ '" calledElement="' + this.callSubProcess + '" >\n';
	if ((this.insource != null && this.intarget != null && this.insource != '' && this.intarget != '')
			|| (this.outsource != null && this.outtarget != null
					&& this.outsource != '' && this.outtarget != '')) {
		xml = xml + '<extensionElements>\n';
	}

	if (this.insource != null && this.intarget != null && this.insource != ''
			&& this.intarget != '') {
		xml = xml + '<activiti:in source="' + this.insource + '" target="'
				+ this.intarget + '"/>\n';
	}
	if (this.outsource != null && this.outtarget != null
			&& this.outsource != '' && this.outtarget != '') {
		xml = xml + '<activiti:out source="' + this.outsource + '" target="'
				+ this.outtarget + '"/>\n';
	}
	if ((this.insource != null && this.intarget != null && this.insource != '' && this.intarget != '')
			|| (this.outsource != null && this.outtarget != null
...
draw2d.CallActivity.prototype.toBpmnDI = function() {
	...
	var xml = '<bpmndi:BPMNShape bpmnElement="' + this.subProcessId
			+ '" id="BPMNShape_' + this.subProcessId + '">\n';
	xml = xml + '<omgdc:Bounds height="' + h + '" width="' + w + '" x="' + x
			+ '" y="' + y + '"/>\n';
